...
#                 f"Charbonnier Loss   : {result['charbonnier_loss']:.6f}"

#             )

#             print(

#                 f"SSIM Loss          : {result['ssim_loss']:.6f}"

#             )

#             print(

#                 f"Edge Loss          : {result['edge_loss']:.6f}"
...
#         f"Channels        : {best_architecture['channels']}"

#     )

#     print(

#         f"RRDB Blocks     : {best_architecture['num_rrdb_blocks']}"
